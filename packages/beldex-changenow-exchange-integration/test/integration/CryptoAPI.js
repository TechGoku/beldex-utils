...
describe('ChangeNow cryptocurrency API integration', async function() {
    ...
    describe('Return filtered Beldex data', function() {
        it('should return a JSON object containing Beldex-specific data', () => {
            this.timeout(5000)
            ...
            // return instance.retrieveFilteredBeldexCurrencyData().then(response => {
            //     console.log(response);
            // })
        })
    })
