...
function YatBeldexLookup(opts = {}) {
    ...
    this.lookupBeldexAddresses = lookupBeldexAddresses
...
// Returns empty object when successful but no data is set. Otherwise, returns object with key => value pair - eg { "0x1001" => "beldexaddress", "0x1002" => "beldexsubaddress" }
// *  
function lookupBeldexAddresses(yat) {
    const self = this;
    // 0x1001 is a Beldex address, 0x1002 is a Beldex subaddress
...
module.exports = YatBeldexLookup;
