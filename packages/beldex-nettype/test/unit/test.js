...
describe('Beldex Net Type', function () {
  describe('#nettypes', function () {
    ...
    it('should return prefix for standard address on mainnet', function () {
      assert.strictEqual(209, nettype.cryptonoteBase58PrefixForStandardAddressOn(0))
    })
    ...
    it('should return prefix for standard address on devnet', function () {
    ...
    it('should return prefix for integrated address on devnet', function () {
    ...
    it('should return prefix for sub address on devnet', function () {
