...
class ExchangeFunctions {
    ...
    constructor() {
        this.apiUrl = "https://api.beldex.io";
        // this.apiVersion = "v3";
        // this.currencyToExchange = "bdx2btc";
        this.offer = {};
        this.offer_type = "";
        this.order = {};
        ...
        return new Promise((resolve, reject) => {
            ...
            axios.post(endpoint, data)
                .then((response) => {
                    ...
                    self.in_currency = "BDX";
                    self.out_currency = "BTC";
                    self.currentRates.minimum_bdx = self.currentRates.in_min;
                    self.currentRates.maximum_bdx = self.currentRates.in_max;
                    resolve(response);
                }).catch((error) => {
                    reject(error);
                })
